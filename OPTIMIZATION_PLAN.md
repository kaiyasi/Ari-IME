...
- 英文 cell 重新解讀注音再補 YAML/TOML key、Docker image tag、regex token，行首 technical literal 不會因 ↑ 被誤轉中文。
...
- 針對更多真實文字樣本持續擴充英文 cell 重新解讀注音測試，例如 Makefile target、Git ref、IPv6/host:port、templating syntax。
